...
class Reproductor:
    ...
    NOTAS_MUSICALES = {
        "SILENCIO":0,"B0":31,"C1":33,"CS1":35,"D1":37,"DS1":39,"E1":41,"F1":44,"FS1":46,"G1":49,"GS1":52,"A1":55,"AS1":58,
        "B1":62,"C2":65,"CS2":69,"D2":73,"DS2":78,"E2":82,"F2":87,"FS2":93,"G2":98,"GS2":104,"A2":110,"AS2":117,"B2":123,
        ...
        "C6":1047,"CS6":1109,"D6":1175,"DS6":1245,"E6":1319,"F6":1397,"FS6":1480,"G6":1568,"GS6":1661,"A6":1760,"AS6":1865,
        "B6":1976,"C7":2093,"CS7":2217,"D7":2349,"DS7":2489,"E7":2637,"F7":2794,"FS7":2960,"G7":3136,"GS7":3322,"A7":3520,
        "AS7":3729,"B7":3951,"C8":4186,"CS8":4435,"D8":4699,"DS8":4978
    }
    CANCIONES = {
        "mario": [
            "E7","E7","SILENCIO","E7","SILENCIO","C7","E7","SILENCIO","G7","SILENCIO","SILENCIO","SILENCIO","G6","SILENCIO",
            "SILENCIO","SILENCIO","C7","SILENCIO","SILENCIO","G6","SILENCIO","SILENCIO","E6","SILENCIO","SILENCIO","A6","SILENCIO",
            "B6","SILENCIO","AS6","A6","SILENCIO","G6","E7","SILENCIO","G7","A7","SILENCIO","F7","G7","SILENCIO","E7","SILENCIO","C7",
            "D7","B6","SILENCIO","SILENCIO","C7","SILENCIO","SILENCIO","G6","SILENCIO","SILENCIO","E6","SILENCIO","SILENCIO","A6",
            "SILENCIO","B6","SILENCIO","AS6","A6","SILENCIO","G6","E7","SILENCIO","G7","A7","SILENCIO","F7","G7","SILENCIO","E7",
            "SILENCIO","C7","D7","B6","SILENCIO","SILENCIO"
        ],
        "PASSED": [
            "G7","SILENCIO","D7","SILENCIO","F4","E7","B6","SILENCIO","SILENCIO"
        ],
        "FAILED": [
            "E7","SILENCIO","C4","E5","SILENCIO","G2","SILENCIO","SILENCIO"
        ],
        "RUNNING":[
            "B0","D4","SILENCIO","A5","B3","SILENCIO","SILENCIO"
        ],
        "CONNECTION_ERROR":[
            "A4","F4","E3","SILENCIO","B4","SILENCIO","SILENCIO"
        ],
        "ACCESS_DENIED":[
            "E7","SILENCIO","C3","E7","SILENCIO","SILENCIO"
        ]
    }
        ...
        if(cancion in self.CANCIONES):
            for nota in self.CANCIONES[cancion]:
                if(nota == "SILENCIO"):
                    ...
                    self.controladorBuzzer.set_intensidad(self.__map__(30))
                    self.controladorBuzzer.set_frecuencia(self.NOTAS_MUSICALES[nota])
                sleep(0.150)
        else:
