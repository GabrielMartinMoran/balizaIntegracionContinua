...
class ConfiguracionGPIO(Configuracion):

    def __init__(self):
        self._ARCHIVO_CONFIGURACION = "configuracion_GPIO.json"
        self._data = {
            "PIN_LED_ROJO"   : None,
            "PIN_LED_VERDE"  : None,
            "PIN_LED_AZUL"   : None,
        }
        super(ConfiguracionGPIO,self)._cargar_archivo_configuracion()
    ...
    def configurar(self, pin_led_rojo, pin_led_verde, pin_led_azul):
        super(ConfiguracionGPIO,self).configurar(pin_led_rojo, pin_led_verde, pin_led_azul)

    def set_pin_led_rojo(self, pin_led_rojo):
        self._data["PIN_LED_ROJO"] = pin_led_rojo
        super(ConfiguracionGPIO,self)._guardar_archivo_configuracion()
